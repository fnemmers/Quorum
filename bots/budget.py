...
def compute_cost_usd(usage):
    ...
    cost = (
        ...
        + cache_creation * PRICE_CACHE_WRITE_PER_MTOK
...
def estimate_run_cost(n_bots, avg_input_tokens=3500, avg_output_tokens=100,
    ...
    """
    first_call_input = avg_input_tokens * PRICE_CACHE_WRITE_PER_MTOK / 1_000_000
    cached_input = (
        avg_input_tokens * cache_hit_fraction * PRICE_CACHE_READ_PER_MTOK
        + avg_input_tokens * (1 - cache_hit_fraction) * PRICE_INPUT_PER_MTOK
    ) / 1_000_000
    per_call_output = avg_output_tokens * PRICE_OUTPUT_PER_MTOK / 1_000_000
